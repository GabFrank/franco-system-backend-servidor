...
public class Local implements Serializable {
    ...
    /** Nombre de la base de datos del servidor central (master). Usado en replicación lógica. */
    @Column(name = "nombre_base_datos_master")
    private String nombreBaseDatosMaster;

    /** Nombre de la base de datos del servidor filial. Usado al conectar a una sucursal. */
    @Column(name = "nombre_base_datos_filial")
    private String nombreBaseDatosFilial;

    /** IP o hostname del servidor central. Usado en replicación lógica (filiales → central). */
