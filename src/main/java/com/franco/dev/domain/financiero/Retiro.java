...
public class Retiro extends EmbeddedEntity implements Serializable {
    ...
    /** FK escalar de la caja de salida (solo lectura, para filtrar sin join sobre la asociación por fórmula). */
    @Column(name = "caja_salida_id", insertable = false, updatable = false)
