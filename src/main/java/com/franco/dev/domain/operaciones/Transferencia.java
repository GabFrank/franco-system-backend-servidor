...
@TypeDef(name = "tipo_transferencia", typeClass = PostgreSQLEnumType.class)
@TypeDef(name = "transferencia_estado", typeClass = PostgreSQLEnumType.class)
@TypeDef(name = "etapa_transferencia", typeClass = PostgreSQLEnumType.class)
public class Transferencia implements Identifiable<Long> {
        ...
        @JoinColumn(name = "hoja_ruta_id", nullable = true)
