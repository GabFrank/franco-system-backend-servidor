...
public class FacturaLegalResolver implements GraphQLResolver<FacturaLegal> {
    ...
    public DocumentoElectronico documentoElectronico(FacturaLegal e) {
        if (e == null || e.getId() == null || e.getSucursalId() == null) {
            return null;
        }
        return documentoElectronicoService.findByFacturaLegalId(e.getId(), e.getSucursalId()).orElse(null);
    }
}
