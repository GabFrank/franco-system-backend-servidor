...
public class ModificacionService extends CrudService<ModificacionRegistro, ModificacionRegistroRepository, Long> {
    ...
    public ModificacionRegistro registrarInsercion(Object entidad, String tipoEntidad, String schemaNombre, String tablaNombre) {
        try {
            ...
            ModificacionRegistro registro = crearRegistroBase(entidad, tipoEntidad, schemaNombre, tablaNombre, TipoOperacion.INSERT);
    ...
    @Transactional(propagation = org.springframework.transaction.annotation.Propagation.REQUIRES_NEW)
    public ModificacionRegistro registrarActualizacion(Object entidadAnterior, Object entidadNueva, String tipoEntidad, String schemaNombre, String tablaNombre) {
        try {
            if (entidadAnterior == null || entidadNueva == null) {
                return null;
            }
            
            ModificacionRegistro registro = crearRegistroBase(entidadNueva, tipoEntidad, schemaNombre, tablaNombre, TipoOperacion.UPDATE);
    ...
    @Transactional(propagation = org.springframework.transaction.annotation.Propagation.REQUIRES_NEW)
    public ModificacionRegistro registrarEliminacion(Object entidad, String tipoEntidad, String schemaNombre, String tablaNombre) {
        try {
            if (entidad == null) {
                return null;
            }
            
            ModificacionRegistro registro = crearRegistroBase(entidad, tipoEntidad, schemaNombre, tablaNombre, TipoOperacion.DELETE);
    ...
    private ModificacionRegistro crearRegistroBase(Object entidad, String tipoEntidad, String schemaNombre, String tablaNombre, TipoOperacion tipoOperacion) {
                    ...
                    if (field.isAnnotationPresent(javax.persistence.ManyToOne.class)) {
                        if (valorAnterior != null) {
                            try {
                                ...
                                if (idValue != null) {
                                    ...
                                    detalle.setValorAnterior(valorAnterior.getClass().getSimpleName() + " (ID: " + idValue + ")");
                                }
                            } catch (Exception e) {
                            }
                        }
                        if (valorNuevo != null) {
                            try {
                                ...
                                if (idValue != null) {
                                    detalle.setValorNuevoId(((Number) idValue).longValue());
                                    detalle.setValorNuevo(valorNuevo.getClass().getSimpleName() + " (ID: " + idValue + ")");
                                }
                            } catch (Exception e) {
                            }
                        }
    ...
    private boolean sonIguales(Object valor1, Object valor2) {
        ...
        try {
            if (valor1.getClass().getDeclaredField("id") != null && valor2.getClass().getDeclaredField("id") != null) {
