...
@Service
@AllArgsConstructor
public class CompraItemService extends CrudService<CompraItem, CompraItemRepository, Long> {
    ...
    public List<CompraItem> findByProductoId(Long id) {
        return repository.findByProductoIdOrderByCreadoEnDesc(id);
    }
