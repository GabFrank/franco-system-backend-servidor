...
public final class HoraExtraCalculator {
     ...
     * son válidos (> 0). recargoPorcentaje nulo se trata como cero.
     */
    public static BigDecimal calcularMonto(BigDecimal sueldoMensual, BigDecimal horasJornada,
                                           BigDecimal minutos, BigDecimal recargoPorcentaje) {
        ...
        // valorHora = sueldo / 30 / horasJornada  (precisión intermedia amplia)
        BigDecimal valorHora = sueldoMensual
                .divide(TREINTA, 6, RoundingMode.HALF_UP)
