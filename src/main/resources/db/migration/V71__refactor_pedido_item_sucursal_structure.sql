-- V71__refactor_pedido_item_sucursal_structure.sql
...
CREATE INDEX idx_pedido_item_sucursal_pedido_item_id ON operaciones.pedido_item_sucursal(pedido_item_id);
CREATE INDEX idx_pedido_item_sucursal_sucursal_id ON operaciones.pedido_item_sucursal(sucursal_id);
CREATE INDEX idx_pedido_item_sucursal_sucursal_entrega_id ON operaciones.pedido_item_sucursal(sucursal_entrega_id);
CREATE INDEX idx_pedido_item_sucursal_usuario_recepcion_id ON operaciones.pedido_item_sucursal(usuario_recepcion_id);
CREATE INDEX idx_pedido_item_sucursal_fecha_recepcion ON operaciones.pedido_item_sucursal(fecha_recepcion);
CREATE INDEX idx_pedido_item_sucursal_rechazado ON operaciones.pedido_item_sucursal(rechazado);
CREATE INDEX idx_pedido_item_sucursal_verificado ON operaciones.pedido_item_sucursal(verificado);
