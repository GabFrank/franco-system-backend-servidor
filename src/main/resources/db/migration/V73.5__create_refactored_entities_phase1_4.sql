...
-- V73.5: Create refactored entities phase 1-4
-- This migration comes from the compras branch

DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'proceso_etapa_tipo') THEN
    ...
    IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'proceso_etapa_estado') THEN
...
CREATE INDEX IF NOT EXISTS idx_proceso_etapa_pedido ON operaciones.proceso_etapa(pedido_id);
CREATE INDEX IF NOT EXISTS idx_proceso_etapa_tipo ON operaciones.proceso_etapa(tipo_etapa);
CREATE INDEX IF NOT EXISTS idx_proceso_etapa_estado ON operaciones.proceso_etapa(estado_etapa);
...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'recepcion_mercaderia_estado') THEN
...
CREATE TABLE IF NOT EXISTS operaciones.recepcion_mercaderia (
    id BIGSERIAL PRIMARY KEY,
...
CREATE INDEX IF NOT EXISTS idx_recepcion_mercaderia_proveedor ON operaciones.recepcion_mercaderia(proveedor_id);
CREATE INDEX IF NOT EXISTS idx_recepcion_mercaderia_sucursal ON operaciones.recepcion_mercaderia(sucursal_recepcion_id);
CREATE INDEX IF NOT EXISTS idx_recepcion_mercaderia_fecha ON operaciones.recepcion_mercaderia(fecha);
CREATE INDEX IF NOT EXISTS idx_recepcion_mercaderia_estado ON operaciones.recepcion_mercaderia(estado);

-- ===============================================
-- 3. RECEPCION MERCADERIA ITEM - Items de recepción física
-- ===============================================

CREATE TABLE IF NOT EXISTS operaciones.recepcion_mercaderia_item (
    id BIGSERIAL PRIMARY KEY,
...
CREATE INDEX IF NOT EXISTS idx_recepcion_item_recepcion ON operaciones.recepcion_mercaderia_item(recepcion_mercaderia_id);
CREATE INDEX IF NOT EXISTS idx_recepcion_item_producto ON operaciones.recepcion_mercaderia_item(producto_id);
CREATE INDEX IF NOT EXISTS idx_recepcion_item_sucursal ON operaciones.recepcion_mercaderia_item(sucursal_entrega_id);

-- ===============================================
-- 4. RECEPCION COSTO ADICIONAL - Costos adicionales (flete, impuestos)
-- ===============================================

CREATE TABLE IF NOT EXISTS operaciones.recepcion_costo_adicional (
    id BIGSERIAL PRIMARY KEY,
    recepcion_mercaderia_id BIGINT NOT NULL,
...
CREATE INDEX IF NOT EXISTS idx_costo_adicional_recepcion ON operaciones.recepcion_costo_adicional(recepcion_mercaderia_id);

-- ===============================================
-- 5. RECEPCION MERCADERIA NOTA - Relación M:N recepciones-notas
-- ===============================================

CREATE TABLE IF NOT EXISTS operaciones.recepcion_mercaderia_nota (
    id BIGSERIAL PRIMARY KEY,
    recepcion_mercaderia_id BIGINT NOT NULL,
...
CREATE INDEX IF NOT EXISTS idx_recepcion_nota_recepcion ON operaciones.recepcion_mercaderia_nota(recepcion_mercaderia_id);
CREATE INDEX IF NOT EXISTS idx_recepcion_nota_nota ON operaciones.recepcion_mercaderia_nota(nota_recepcion_id);
...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'devolucion_estado') THEN
...
CREATE TABLE IF NOT EXISTS operaciones.devolucion (
    id BIGSERIAL PRIMARY KEY,
    proveedor_id BIGINT NOT NULL,
...
CREATE INDEX IF NOT EXISTS idx_devolucion_proveedor ON operaciones.devolucion(proveedor_id);
CREATE INDEX IF NOT EXISTS idx_devolucion_sucursal ON operaciones.devolucion(sucursal_origen_id);
CREATE INDEX IF NOT EXISTS idx_devolucion_fecha ON operaciones.devolucion(fecha);
CREATE INDEX IF NOT EXISTS idx_devolucion_estado ON operaciones.devolucion(estado);

-- ===============================================
-- 7. DEVOLUCION ITEM - Items específicos de devolución
-- ===============================================

CREATE TABLE IF NOT EXISTS operaciones.devolucion_item (
    id BIGSERIAL PRIMARY KEY,
...
CREATE INDEX IF NOT EXISTS idx_devolucion_item_devolucion ON operaciones.devolucion_item(devolucion_id);
CREATE INDEX IF NOT EXISTS idx_devolucion_item_producto ON operaciones.devolucion_item(producto_id);

-- ===============================================
-- 8. PEDIDO ITEM DISTRIBUCION - Distribución planificada entre sucursales
-- ===============================================

CREATE TABLE IF NOT EXISTS operaciones.pedido_item_distribucion (
    id BIGSERIAL PRIMARY KEY,
...
CREATE INDEX IF NOT EXISTS idx_distribucion_pedido_item ON operaciones.pedido_item_distribucion(pedido_item_id);
CREATE INDEX IF NOT EXISTS idx_distribucion_sucursal ON operaciones.pedido_item_distribucion(sucursal_entrega_id);

-- ===============================================
-- 9. SOLICITUD PAGO RECEPCION - Relación M:N pagos-recepciones
-- ===============================================

CREATE TABLE IF NOT EXISTS operaciones.solicitud_pago_recepcion (
    id BIGSERIAL PRIMARY KEY,
...
CREATE INDEX IF NOT EXISTS idx_pago_recepcion_solicitud ON operaciones.solicitud_pago_recepcion(solicitud_pago_id);
CREATE INDEX IF NOT EXISTS idx_pago_recepcion_recepcion ON operaciones.solicitud_pago_recepcion(recepcion_mercaderia_id);
