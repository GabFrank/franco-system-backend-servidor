...
CREATE INDEX idx_nota_recepcion_item_distribucion_nota_recepcion_item 
    ON operaciones.nota_recepcion_item_distribucion(nota_recepcion_item_id);

CREATE INDEX idx_nota_recepcion_item_distribucion_sucursal_entrega 
    ON operaciones.nota_recepcion_item_distribucion(sucursal_entrega_id);

CREATE INDEX idx_nota_recepcion_item_distribucion_usuario 
