...
ADD COLUMN es_nota_rechazo BOOLEAN DEFAULT FALSE;

-- Step 2: Create index for better performance on filtering
CREATE INDEX idx_nota_recepcion_es_nota_rechazo ON operaciones.nota_recepcion(es_nota_rechazo);
...
WHERE tipo_boleta = 'RECHAZO_NO_ENTREGADO';
