...
(1, 'AJUSTE_STOCK', 'Notificación de ajuste de stock manual', true, NOW()),
(5, 'AJUSTE_STOCK', 'Notificación de ajuste de stock manual', false, NOW()),
(1, 'AJUSTE_COSTO', 'Notificación de ajuste de costo de producto', true, NOW()),
...
(1, 'FACTURA_ALTO_VALOR', 'Alerta de factura con monto alto (>= 3M)', false, NOW()),
